...
Player.destroy_all
p1 = Player.create(:name => 'Lionel Messi', :nationality => 'Argantina', :dob => '24-05-1987', :market_value => '150mil',
:position => 'Right Winger',
:image => 'https://www.fcbarcelona.com/photo-resources/2019/09/12/2c22eb75-7530-47bc-9ea8-92b492b6780a/
Messi-600x708.png?width=1340&height=1580', :goals => '')
p2 = Player.create(:name => 'Ousmane Dembélé', :nationality => 'France', :dob => '15-05-1997', :market_value => '100mil',
:position => 'Left Winger',
:image => 'https://www.fcbarcelona.com/photo-resources/2019/09/12/1d0e5cdd-
8891-4d8e-9ce4-703f7642a728/Dembele-600x708.png?width=1340&height=1580', :goals => '')
p3 = Player.create(:name => 'Antoine Griezmann', :nationality => 'France', :dob => '21-03-1991', :market_value => '130mil',
:position => 'Center-Forward',
:image => 'https://www.fcbarcelona.com/photo-resources/2019/09/12/0
03f5e86-ddfe-43ff-940e-d4a51605b948/Griezmann-600x708.png?width=1340&height=1580', :goals => '')
...
:image => 'https://www.logospng.com/images/36/dateiuefa-logopng-ndash-wikipedia-36707.png' )
co2 = Confederation.create (:name => 'South America', :country => 'Brazil, Argantina', :league => 'Brazil Serie A, Superliga',
:image => 'https://upload.wikimedia.org/wikipedia/en/a/a8/CONMEBOL_logo_%282017%29.svg' )
...
puts "Confederations and stadia"
s1.stadia << co1
s2.stadia << co2
